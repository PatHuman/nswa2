...
export default {
    ...
    home:{
        bigTitle:{
            title:"NEXT STOP West Africa",
            subtitle:"Next stop, for a quality of life and better living",
            link:"Our Services"
        },
        about:{
            title:"Who We Are",
            ...
            vision: {
                title:"Vision",
                text:"Provide consumers with a range of innovative solutions (products & services) which meet international climatic and environmental standards for the protection of goods, people, and their consumption."
            },
            values: {
                title:"Valeus",
                list:{
        ...
        service:{
            ...
            pheromone:{
                ...
                text:`Pheromones are volatile substances secreted by living beings (animals, insects, certain plants, etc.), more generally by females. They play a role of recognition and sexual attraction on males who can detect them several kilometers away. Each species emits a specific pheromone. The use of this substance makes it possible to fight very precisely and very effectively against each type of pest.
                      ...
                      Next Stop exclusively distributes the FLYBYE aggregation pheromone developed by the European company Green Universe to effectively fight against house flies, responsible for transporting pathogens causing many diseases`
            },
            biologic:{
                title:"Natural and organic products",
                text:"Next Stop develops with its international partners, products based on plant essences for the biological control of certain domestic pests."
            },
            mechanic:{
                title:"Mechanical control methods",
                text:"Next Stop has a range of sticky adhesive tapes and pests are attracted by the color of the tapes. This helps to significantly reduce parasite pressure in infested areas."
            },
            chemical:{
                title:"New generation chemical products",
                text:"Next Stop with its international partners distribute innovative non-harmful chemical products that respect the main challenges related to climate and environmental issues in the fight against disease vectors and other undesirable pests in our habitats."
            },
            digital:{
                title:"Digitalisation Services",
                text:`As part of next Stop’s long-term development vision, it is orientated towards the efficient use of Information Communication Tool’s (ICT) in the field of parasite control in public hygiene. As such, the next generation of pest control solutions integrate controls and technologies to improve pest control activities and keep the places we frequent uninterrupted by pests and vector-borne diseases. 
        ...
        pillar:{
            ...
            distrib:{
                ...
                text:`In West Africa, the distribution network often has many shortcomings and is characterized by poor quality products; counterfeiting problems; unstructured, inefficient, and informal distribution without real support for end consumers; lack of sound advice in the use of pest control products due to resellers who do not have the relevant information and unable to provide the advice essential to the success of technical operations.
                    ...
                    These resellers benefit from regular technical support through training and advice provided by the company. The objective is to provide the consumer with the right product, at the right time, in the right place and at the right price`
            },
            conseil:{
                title:"Advisory",
                text:"Advisory is a strong pillar of our approach. Systematically, all the company's customers, regardless of their level of collaboration with Next Stop, benefit from this service because ultimately, we remain convinced that good advice always makes the difference in the long term."
            },
            formation:{
                title:"Training",
                text:"The training of applicators and other customers is another pillar of the company's approach. In partnership with our suppliers, training modules are addressed in order to make the effects of our products efficient."
            },
            partner:{
                title:"Partnerships",
                text:"At the heart of its growth strategy, Next Stop considers partnerships to be the main key factor in the success of its approach. These partnerships take the form of joint programs for the development of products and concepts, the development of markets, the structuring of private distribution, territorial representation, support for technical and marketing activities, etc."
            },
            advocacy:{
                title:"Advocacy",
                text:"Next Stop aims, by collaborating with local and international actors, to structure the public hygiene sector by organizing the stakeholders of the value chain (PCO, resellers, advisers, institutions, etc.) through the method of professionalization. The long-term objective is to build strong associations to constitute an important channel in decisions related to this sector."
            },
        ...
        objectif:{
            ...
            section:{
                    ...
                    vector:{
                        ...
                        moskito:{
                            ...
                            text:`Malaria: 
                                ...
                                These mosquitoes are responsible for many other diseases, namely the Chikungunya virus, the yellow fever virus, the Zika virus, etc.`
                        }
    
                    },
                    pest:{
                        title:"Professional Pest Management",
                        text:`Professional pest management brings together a set of integrated actions capable of eliminating the majority of these pests and other unwanted pests in our habitat and environment.
                            ...
                            These sectors are mainly those of restaurants, hotels, households, industries, etc. Next Stop establishes distribution partnerships with international companies that develop pest control activities.`
                             
                    },
                    environment:{
                        title:"Environmental management and protection of green spaces",
                        text:`Next Stop is constantly looking for partners developing solutions in the fields of environmental management to manage green spaces.
                ...
                client:{
                    title:"Our client categories",
                    subtitle:"",
                    agents:{
                        title:"Pest control product applicators (PCO)",
                        text:`These professionals are a very essential link in achieving the results of the effectiveness of its products. Therefore, NEXT STOP pays particular attention to the choice of its PCO partners in the execution of treatment programs.
                            In addition, Next Stop contributes to the upgrading of these professionals to consider the evolution of legislation and standards in this area, through training and regular technical support.`
                    },
                    industry:{
                    ...
                    storage:{
                        title:"Farmers and grain storage professionals",
                        text:"The role of pests in the destruction of grain stocks is well established. In partnership with international companies, Next Stop offers a range of products with proven effectiveness and meeting international food consumption requirements."
                    }
        ...
        media:{
            title:"Media",
            subtitle:"Galery photos and videos",
            all:"All",
            photo:"Photos",
            video:"Videos"
        },
    ...
    objectif:{
        ...
        section:{
            domain:{
                ...
                pest:{
                    title:"Professional Pest Management",
                    intro:`Professional pest management brings together a set of integrated actions capable of eliminating the majority of these pests and other unwanted pests in our habitat and environment.
                        Willing to carry its vision and deliver its objectives, in partnership with worldwide companies, Next Stop identifies, analyzes and selects the best practices in this area in order to make this fight possible in various affected economic sectors.
                        These sectors are mainly those of restaurants, hotels, households, industries, etc. Next Stop establishes distribution partnerships with international companies that develop pest control activities.`
